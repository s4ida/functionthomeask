...
//     let countryarray = mydata.find(item => item.id === c);
//     console.log(countryarray.shipAddress.country);
// }


// 2.Ölkəyə görə obyekti tapa function yazın.
// function findObject (a) {
//     let objectArray = mydata.filter(item=>item.shipAddress.country === a )
...
//   function id (a) {
//     let NewArray = mydata.find(item => item.id === a);
//     console.log(NewArray.shipName);
//     console.log(NewArray.shipAddress.country);
//     console.log(NewArray.shipAddress.city);
// }



// 4.ID-ə görə neçə növdə satış edildiyini göstərən function yazın. (details sayı)
// function finddetails (a) {
//     let dataArray = mydata.find(item=>item.id === a );
//     console.log(dataArray.details);
// }
...
// function qazanc(d) {
//     let newArray=mydata.find(item => item.id ===d);
//     console.log(newArray.details[0].quantity*newArray.details[0].unitPrice*(1-newArray.details[0].discount));
// }
